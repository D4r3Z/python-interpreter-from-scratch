...
from nodes import *
class Parser:
    def __init__(self,tokens: deque) -> None:
        self.tokens=tokens
        self.curtok=None
    def __del__(self):
        del self.tokens
    ...
    def comp_expr(self):
        ...
        node = self.tree_walk(self.arith_expr, (tt_tokens.TT_BOOL_EQ, tt_tokens.TT_BOOL_NE, tt_tokens.TT_BOOL_LT, tt_tokens.TT_BOOL_GT, tt_tokens.TT_BOOL_LTE, tt_tokens.TT_BOOL_GTE))
        return node
    def arith_expr(self):
    ...
    def atom(self):
        ...
        print(tok)
        raise Exception('Syntax error')
    def tree_walk(self,func_a,ops,func_b=None):
        if not func_b:
            func_b=func_a
        left=func_a()
